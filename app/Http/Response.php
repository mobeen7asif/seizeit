...
class Response
{
    ...
    public function respondValidationFails($messages = ["Your request did not pass our server requirements!"])
    {
    ...
    public function respondUserNotFound($messages = ["User not found."])
    {
        return $this->setHttpStatus(404)->setCustomStatus(700)->setErrorMessages($messages)->respondWithErrors();
    }
